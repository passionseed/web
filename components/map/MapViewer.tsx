...
import {
  ...
  ViewerTextNode,
  ViewerCommentNode,
} from "@/components/map/MapViewerNodeTypes";
...
const nodeTypes = {
  default: MapViewerNode,
  text: ViewerTextNode,
  comment: ViewerCommentNode,
};
...
export function MapViewer({ map, seedRoomId, seedTitle, seedId, roomSettingsComponent }: MapViewerProps) {
  ...
  }, [reactFlowInstance, selectedNode, isNodeUnlocked]); // Added isNodeUnlocked dependency
  ...
  }, [map.map_nodes, isNodeUnlocked, reactFlowInstance, selectedNode]);
  ...
  }, [map, progressMap, setNodes, setEdges, isNodeUnlocked, isNodeCompleted, getSubmissionRequirement, isInstructorOrTA, isTeamMap, userRole, selectedNode]);
    ...
    <div className="h-full flex flex-col">
      ...
      <ResizablePanelGroup id="map-viewer-panels" direction="horizontal" className="flex-1">
        ...
        >
          ...
          {/* ... Rest of the component (Navigation Guide, etc) ... */}
