...
import { DefaultMapNode } from "@/components/map/MapNodeComponents";
...
export function MapViewer({ map, seedRoomId, seedTitle, seedId, roomSettingsComponent }: MapViewerProps) {
  ...
  const nodeTypes = useMemo(() => ({
    ...
    comment: ({
      ...
      data: MapNode & { node_type?: string; [key: string]: any };
      selected?: boolean;
    }) => {
  ...
  }, [map, progressMap, setNodes, setEdges, isInstructorOrTA, isTeamMap, userRole]);
