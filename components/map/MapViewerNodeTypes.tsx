...
const CommentNodeWrapper = ({
  ...
  const { isInstructorOrTA = false, userRole } = data;
...
export const nodeTypes = {
  default: memo(DefaultNode),
  text: memo(TextNodeWrapper),
  comment: memo(CommentNodeWrapper),
};
