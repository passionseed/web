...
// Types for extended data properties passed to nodes
export interface MapNodeData extends MapNode {
  ...
  isTeamMap?: boolean;
  userRole?: string;
  submission_requirement?: "single" | "all";
  node_type?: string;
}
...
const CommentNodeWrapper = memo(({
  ...
  const isInstructorOrTA = data.isInstructorOrTA || false;
