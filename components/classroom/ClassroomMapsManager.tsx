...
export function ClassroomMapsManager({
  ...
  const loadTeamForkedMaps = async () => {
    console.log(
      "🔄 ClassroomMapsManager: Loading team forked maps for classroom:",
      classroomId
    );
    ...
    try {
      ...
      console.error(
        "❌ ClassroomMapsManager: Failed to load team forked maps:",
        error
      );
      toast({
        title: "Error",
              ...
              {linkedMaps.map((map) => (
                ...
                >
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <Link
                      href={`/classrooms/${classroomId}/maps/${map.link_id}/grading`}
                    >
                      <Button variant="outline" size="sm">
                        Grade
                      </Button>
              ...
              {teamForkedMaps.map((teamMap) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center space-x-4 text-xs text-muted-foreground">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span>
                          Forked{" "}
                          {new Date(teamMap.forked_at).toLocaleDateString()}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    {/* Grade link */}
                    <Link
                      href={`/classrooms/${classroomId}/maps/${teamMap.team_map_id}/grading`}
                    >
                      <Button variant="outline" size="sm">
                        Grade
                      </Button>
